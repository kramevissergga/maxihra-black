 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const arrowsSlider = document.querySelectorAll(".hero__slider");
    ...
    document.addEventListener("click", (e => {
        ...
        if (e.target.closest(".lang__value")) lang.classList.toggle("_active"); else lang.classList.remove("_active");
